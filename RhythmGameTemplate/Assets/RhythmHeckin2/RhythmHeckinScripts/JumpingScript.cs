...
public class JumpingScript : MonoBehaviour {
	...
	public GameObject bamboo1, bamboo2;
	...
	public void BFall() {
		if (!_animator.GetBool("isFalling")) {
			...
			//if(bamboo1 || bamboo2)
   //         {
			//	currentBamboo.GetComponent<BambooController>().Failed();
			//}
	...
	public void BJump() {
		...
		if (bamboo1 || bamboo2)
        {
			currentBamboo.GetComponent<BambooController>().Sliced();
			
		}
		//currentBamboo.GetComponent<>
	...
	public void SetBamboo1()
    {
		currentBamboo = bamboo1;

	}
	public void SetBamboo2()
    {
		currentBamboo = bamboo2;
    }
